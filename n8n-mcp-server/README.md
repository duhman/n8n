...
✅ **Production Ready** - The server is stable and tested with n8n 1.102.0 and fully configured for the live production instance at https://n8n.whatisspeed.com.

- **Current Version**: 0.1.9
- **MCP SDK Version**: 1.15.0 (latest)
- **n8n Compatibility**: 1.102.0+
- **Production Instance**: https://n8n.whatisspeed.com/api/v1 ✅ Connected
...
```json
{
  "mcpServers": {
    ...
    "n8n-local": {
      ...
      "env": {
        "N8N_API_URL": "https://n8n.whatisspeed.com/api/v1", // Production instance
        "N8N_API_KEY": "YOUR_N8N_API_KEY", // Generate from n8n Settings > API Keys
...
Test your connection to the n8n instance:
...
- ✅ API connectivity to your n8n instance
